...
CREATE TABLE IF NOT EXISTS public.publications (
  ...
  payment_proof_confirmed BOOLEAN DEFAULT false,
  payment_proof_confirmed_at TIMESTAMPTZ,
  payment_proof_confirmed_by UUID REFERENCES auth.users(id) ON DELETE SET NULL,
  admin_comment TEXT,
